...
{
    public partial class FRM_INGRESA_PEDIDOS_CLIENTES : FormaBase
    {      
        int res = 0;
        ...
        public FRM_INGRESA_PEDIDOS_CLIENTES()
        {
            InitializeComponent();
        }
        ...
        private void btnBuscaCliente_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                K_Cliente = 0;
                K_Paciente = Convert.ToInt32(frm.K_Cliente_Seleccionado);
        ...
        private void btnBuscaArticulo_Click(object sender, EventArgs e)
        {
            ...
            if (frm.LLave_Seleccionado > 0)
            {
                ...
                K_Unidad_Medida = frm.K_Unidad_Medida_Seleccionado;
                txtTasaIVA.Text = frm.Tasa_IVA_Seleccionado.ToString("N2");
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if (dtDetalle.Rows.Count == 0)
            {
                ...
                dr["K_Unidad_Medida"] = K_Unidad_Medida;
        ...
        void MtdGuardar()
        {
            if (BaseFuncionValidaciones())
            {
                ...
                dt.Columns.Remove("Comentarios");
                dt.Columns.Remove("B_Facturado");
                dt.Columns.Remove("D_Unidad_Medida");
             
                res = sqlPedidos.In_Pedidos(ref K_Pedido, 0, "", GlobalVar.K_Oficina, 0, 0, 0, 0, 0, 0, 2, dtpVigencia.Value,
                    Convert.ToInt32(txtClaveCliente.Text.Trim()), 0, txtPorcentajeDescuento.Text.Trim().Length > 0 ? Convert.ToDecimal(txtPorcentajeDescuento.Text.Trim()):0,
                    ...
                    1, 1, GlobalVar.K_Usuario, dt, GlobalVar.PC_Name, false, 2, 0, "", dtpVigencia.Value, "", false,
                    false, true, 0, "", 0, "", 0, "", "", 0, 0, "", false, 0, "", "", "", false, 0,false, ref msg);
                ...
                {
                    MessageBox.Show("REGISTRO GUARDADO CORRECTAMENTE" + System.Environment.NewLine + "Se generó el Número de Pedido  " + K_Pedido.ToString(), "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
