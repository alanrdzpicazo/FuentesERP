...
{
    public partial class FRM_SUSTANCIA_ACTIVA: FormaCatalogo
    {
        public FRM_SUSTANCIA_ACTIVA()
        {
            InitializeComponent();
        }
        int res = 0;
        ...
        public override void BaseMetodoInicio()
        {
            ...
            BaseDtDatos = sql_Catalogos.Sk_Sustancia_Activa();
        ...
        public override void BaseBotonGuardarClick()
        {
            ...
            {
                res = sql_Catalogos.In_Sustancia_Activa(ref CampoIdentity, txtDescripcion.Text, ref msg);

            }
            else //Existe. Update
            {
                CampoIdentity = Convert.ToInt16(CatalogoPropiedadId_Identity);
                res = sql_Catalogos.Up_Sustancia_Activa(CampoIdentity, txtDescripcion.Text, ref msg);
            }
        ...
        public override void BaseBotonBorrarClick()
        {
            ...
            {
                res = sql_Catalogos.Dl_Sustancia_Activa(Convert.ToInt16(CatalogoPropiedadId_Identity), ref msg);
        ...
        public override void CatalogoMetodoLlenaControles(DataRow ren)
        {
            ...
            txtClave.Text = ren["K_Sustancia_Activa"].ToString();
            txtDescripcion.Text = ren["D_Sustancia_Activa"].ToString();
