...
{
    public partial class FRM_ACTUALIZA_ZONIFICACION_LPAMBULANCIA_ASEG : FormaBase
    {
        ...
        int K_Precio_Local_AmbAseg = 0, K_Pais = 0, K_Estado = 0, K_Ciudad = 0, K_Oficina = 0, K_Precio_Ambulancia = 0;
        ...
        public FRM_ACTUALIZA_ZONIFICACION_LPAMBULANCIA_ASEG(int _K_Precio_Local_AmbAseg, int _K_Pais, int _K_Ciudad, string _D_Ciudad, int _K_Estado, int _K_Oficina, int _K_Precio_Amblancia, decimal _Precio, DateTime _FechaInicio, DateTime _FechaFinal)
        {
            InitializeComponent();
            K_Pais = _K_Pais;
            K_Estado = _K_Estado;
            ...
            K_Precio_Local_AmbAseg = _K_Precio_Local_AmbAseg;
        }
        private void FRM_ACTUALIZA_ZONIFICACION_LPAMBULANCIA_ASEG_Load(object sender, EventArgs e)
        {
        ...
        public override void BaseBotonGuardarClick()
        {
            ...
            try
            {
                res = catalogosSQL.Up_Zonificacion_LPAmbulancia_Aseg(Convert.ToInt16(K_Precio_Local_AmbAseg), Convert.ToInt16(K_Pais), K_Estado, K_Ciudad, K_Precio_Ambulancia, K_Oficina, Convert.ToDecimal(txtPrecio.Text), FechaInicial, FechaFinal, ref msg);
            }
            catch (Exception)
            {
