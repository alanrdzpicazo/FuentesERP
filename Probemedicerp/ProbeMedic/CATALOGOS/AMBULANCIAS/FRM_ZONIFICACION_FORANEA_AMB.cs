...
{
    public partial class FRM_ZONIFICACION_FORANEA_AMB : FormaBase
    {
        ...
        private void FRM_ZONIFICACION_FORANEA_AMB_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Agregar_Click(object sender, EventArgs e)
        {
            ...
            if (K_Ciudad_Disp != 0)
            {
                res = sql_Catalogos.In_Zonificacion_Foranea_Ambulancia(ucOficinas1.K_Oficina, geo_Pais1.K_Pais, geo_Pais1.K_Estado, K_Ciudad_Disp, GlobalVar.K_Usuario, ref msg);
                if (res == -1)
                {
        ...
        private void btn_Eliminar_Click(object sender, EventArgs e)
        {
            ...
            if (K_Ciudad_Asig != 0)
            {
                res = sql_Catalogos.Dl_Zonificacion_Foranea_Ambulancia(ucOficinas1.K_Oficina, geo_Pais1.K_Pais, geo_Pais1.K_Estado, K_Ciudad_Asig, GlobalVar.K_Usuario, ref msg);
        ...
        public FRM_ZONIFICACION_FORANEA_AMB()
        {
            InitializeComponent();
        ...
        private void Llena_Disponible()
        {
            ...
            CD_Disponibless = sql_Catalogos.Sk_Ciudades_Disp_Foranea(ucOficinas1.K_Oficina, geo_Pais1.K_Pais, geo_Pais1.K_Estado);
        ...
        private void Llena_Asignado()
        {
            ...
            CD_Asignadass = sql_Catalogos.SK_Zonificacion_Foranea_Ambulancia(ucOficinas1.K_Oficina, geo_Pais1.K_Pais, geo_Pais1.K_Estado);
