...
{
    public partial class FRM_ZONIFICACION_FORANEA_PRECIOS_AMBULANCIAS : FormaBase
    {
        SQLCatalogos catalogosSQL = new SQLCatalogos();
        Funciones fx = new Funciones();

        DataTable datos = new DataTable();
        int K_Precio_Foraneo_Ambulancias = 0, K_Pais = 0, K_Estado = 0, K_Ciudad = 0, K_Oficina = 0, K_Precio_Ambulancia = 0;
        ...
        private void FRM_ZONIFICACION_FORANEA_PRECIOS_AMBULANCIAS_Load(object sender, EventArgs e)
        {

        }
        public FRM_ZONIFICACION_FORANEA_PRECIOS_AMBULANCIAS()
        {
            InitializeComponent();
        }
        ...
        public void LLenarGrid(int K_Pais, Int32 K_Estado, Int32 K_Ciudad, Int32 K_Precio_Ambulancia, int K_Oficina, DateTime FechaInicial, DateTime FechaFinal)
        {
            ...
            datos = catalogosSQL.SK_Zonificacion_Foranea_Precios_Ambulancias(Convert.ToInt16(K_Pais), K_Estado, K_Ciudad, K_Precio_Ambulancia, K_Oficina, FechaInicial, FechaFinal);
            ...
            if (datos != null)
            {
                ...
                grdDatos.Columns["K_Precio_Foraneo_Ambulancia"].HeaderText = "Clave";
        ...
        public override void BaseBotonGuardarClick()
        {
            ...
            try
            {
                res = catalogosSQL.In_Zonificacion_Foranea_Precios_Ambulancias(Convert.ToInt16(zonFA_Oficina1.K_Pais), Convert.ToInt32(zonFA_Oficina1.K_Estado), Convert.ToInt16(zonFA_Oficina1.K_Ciudad), Convert.ToInt32(K_Precio_Ambulancia), Convert.ToInt16(zonFA_Oficina1.K_Oficina), Convert.ToDecimal(txtPrecio.Text), FechaInicial, FechaFinal, ref msg);
            }
            catch (Exception)
            {
        ...
        public override void BaseBotonBuscarClick()
        {
            ...
            K_Pais = zonFA_Oficina1.K_Pais;
            K_Estado = zonFA_Oficina1.K_Estado;
            K_Ciudad = zonFA_Oficina1.K_Ciudad;
            K_Oficina = zonFA_Oficina1.K_Oficina;
            ...
            //FRM_ACTUALIZA_ZONIFICACION_FORANEA_PRECIOS_AMBULANCIA actualiza = new FRM_ACTUALIZA_ZONIFICACION_FORANEA_PRECIOS_AMBULANCIA(K_Pais, K_Ciudad, D_Ciudad, K_Estado, K_Oficina, K_Precio_Ambulancia, Convert.ToDecimal(grdDatos.CurrentRow.Cells["Precio"].Value.ToString()), FechaInicial, FechaFinal);
        ...
        private void FRM_ZONIFICACION_FORANEA_PRECIOS_AMBULANCIAS_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            zonFA_Oficina1.txt_G_Pais.Text = string.Empty;
            zonFA_Oficina1.txt_G_Estado.Text = string.Empty;
            zonFA_Oficina1.txt_G_Ciudad.Text = string.Empty;
            zonFA_Oficina1.txt_G_Oficina.Text = string.Empty;
        ...
        public override void BaseBotonModificarClick()
        {
            ...
            BaseBotonGuardar.Enabled = false;
            K_Precio_Foraneo_Ambulancias = int.Parse(grdDatos.CurrentRow.Cells["K_Precio_Foraneo_Ambulancia"].Value.ToString());
            K_Pais = int.Parse(grdDatos.CurrentRow.Cells["K_Pais"].Value.ToString());
            K_Estado = int.Parse(grdDatos.CurrentRow.Cells["K_Estado"].Value.ToString());
            K_Ciudad = int.Parse(grdDatos.CurrentRow.Cells["K_Ciudad"].Value.ToString());
            K_Oficina = int.Parse(grdDatos.CurrentRow.Cells["K_Oficina"].Value.ToString());
            ...
            FechaInicial = Convert.ToDateTime(grdDatos.CurrentRow.Cells["F_Inicio"].Value.ToString());
            FechaFinal = Convert.ToDateTime(grdDatos.CurrentRow.Cells["F_Final"].Value.ToString());
            FRM_ACTUALIZA_ZONIFICACION_FORANEA_PRECIOS_AMBULANCIA actualiza = new FRM_ACTUALIZA_ZONIFICACION_FORANEA_PRECIOS_AMBULANCIA(K_Precio_Foraneo_Ambulancias, K_Pais, K_Ciudad, D_Ciudad, K_Estado, K_Oficina, K_Precio_Ambulancia, Convert.ToDecimal(grdDatos.CurrentRow.Cells["Precio"].Value.ToString()), FechaInicial, FechaFinal);
            actualiza.ShowDialog(this);
