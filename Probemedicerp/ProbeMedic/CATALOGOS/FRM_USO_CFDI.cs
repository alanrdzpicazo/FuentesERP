...
{
    public partial class FRM_USO_CFDI : FormaCatalogo
    {
        int res = 0;
        ...
        public override void BaseMetodoInicio()
        {
            ...
            BaseDtDatos = sql_Catalogos.Sk_Uso_CFDI();
        ...
        public override void BaseBotonGuardarClick()
        {
            ...
            {
                res = sql_Catalogos.In_Uso_CFDI(ref CampoIdentity, txtDescripcion.Text, txtClaveSAT.Text.Trim(), GlobalVar.K_Usuario, ref msg);
        ...
        public override void BaseBotonBorrarClick()
        {
            ...
            {
                res = sql_Catalogos.Dl_Uso_CFDI(Convert.ToInt32(CatalogoPropiedadId_Identity), GlobalVar.K_Usuario, ref msg);
        ...
        public override void CatalogoMetodoLlenaControles(DataRow ren)
        {
            ...
            txtClave.Text = ren["K_Uso_CFDI"].ToString();
            txtDescripcion.Text = ren["D_Uso_CFDI"].ToString();
