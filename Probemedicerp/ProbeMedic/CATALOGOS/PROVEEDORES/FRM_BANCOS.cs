...
{
    public partial class FRM_BANCOS : FormaCatalogo
    {
        int res = 0;
        ...
        public override void BaseMetodoInicio()
        {
            ...
            BaseDtDatos = sql_Catalogos.Sk_Bancos();
        ...
        public override void BaseBotonGuardarClick()
        {
            ...
            {
                res = sql_Catalogos.In_Bancos(ref CampoIdentity, txtDescripcion.Text, txtCorto.Text,txtRFC.Text.Trim(), ref msg);

            }
            else //Existe. Update
            {
                CampoIdentity = Convert.ToInt16(CatalogoPropiedadId_Identity);
                res = sql_Catalogos.Up_Bancos(CampoIdentity, txtDescripcion.Text, txtCorto.Text, txtRFC.Text.Trim(), ref msg);
            }
        ...
        public override void BaseBotonBorrarClick()
        {
            ...
            {
                res = sql_Catalogos.Dl_Bancos(Convert.ToInt16(CatalogoPropiedadId_Identity), ref msg);
        ...
        public override void CatalogoMetodoLlenaControles(DataRow ren)
        {
            ...
            txtClave.Text = ren["K_Banco"].ToString();
            txtDescripcion.Text = ren["D_Banco"].ToString();
            txtCorto.Text = ren["C_Banco"].ToString();
            txtRFC.Text  = ren["RfcBanco"].ToString();
        }
    }
}
