...
{
    public partial class FRM_ZONIFICACION_FP_ENFERMERIA : FormaBase
    {
        public FRM_ZONIFICACION_FP_ENFERMERIA()
        {
            InitializeComponent();
        }
        ...
        private void BtnAgergar_Click(object sender, EventArgs e)
        {
            ...
            res = catalogosSQL.In_Zonificacion_Foranea_Precios_Enfermeria(Convert.ToInt16(zonFE_Oficina1.K_Pais), Convert.ToInt32(zonFE_Oficina1.K_Estado), Convert.ToInt16(zonFE_Oficina1.K_Ciudad), Convert.ToInt32(K_Precio_Enfermeria), Convert.ToInt16(zonFE_Oficina1.K_Oficina), Convert.ToDecimal(txtPrecio.Text), FechaInicial, FechaFinal, ref msg);
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            LLenarGrid(K_Pais, K_Estado, K_Ciudad, K_Precio_Enfermeria, K_Oficina, FechaInicial, FechaFinal);
        ...
        public void LLenarGrid(int K_Pais, Int32 K_Estado, Int32 K_Ciudad, Int32 K_Precio_Enfermeria, int K_Oficina, DateTime FechaInicial, DateTime FechaFinal)
        {
            datos = catalogosSQL.SK_Zonificacion_Foranea_Precios_Enfermeria(Convert.ToInt16(K_Pais), K_Estado, K_Ciudad, K_Precio_Enfermeria, K_Oficina, FechaInicial, FechaFinal);
            msg = string.Empty;
            ...
            if (datos != null)
            {
                ...
                grdDatos.Columns["K_Precio_Foraneo_Enfermeria"].HeaderText = "Clave";
        ...
        private void btnBuscarCaracteristicas_Click_1(object sender, EventArgs e)
        {
            BuscaEnfermeria();
        }
        ...
        private void FRM_ZONIFICACION_FP_ENFERMERIA_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        public override void BaseBotonModificarClick()
        {
            ...
            BaseBotonGuardar.Enabled = false;
            K_Precio_Foraneo_Enfermeria = int.Parse(grdDatos.CurrentRow.Cells["K_Precio_Foraneo_Enfermeria"].Value.ToString());
            ...
            FRM_ACTUALIZA_ZFP_ENFERMERIA actualiza = new FRM_ACTUALIZA_ZFP_ENFERMERIA(K_Precio_Foraneo_Enfermeria, K_Pais, K_Ciudad, D_Ciudad, K_Estado, K_Oficina, K_Precio_Enfermeria, Convert.ToDecimal(grdDatos.CurrentRow.Cells["Precio"].Value.ToString()), FechaInicial, FechaFinal);
