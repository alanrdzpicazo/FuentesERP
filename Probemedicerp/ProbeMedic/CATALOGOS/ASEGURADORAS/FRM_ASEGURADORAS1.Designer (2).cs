...
namespace ProbeMedic.CATALOGOS
{
    public partial class FRM_ASEGURADORAS : FormaCatalogo
    {
        ...
        public override void BaseBotonGuardarClick()
        {
            ...
            {
                res = sql_Catalogos.In_Aseguradora(ref CampoIdentity, txtDescripcion.Text, txtCorto.Text, ref msg);

            }
            else //Existe. Update
            {
                CampoIdentity = Convert.ToInt16(CatalogoPropiedadId_Identity);
                res = sql_Catalogos.Up_Aseguradora(CampoIdentity, txtDescripcion.Text, txtCorto.Text, ref msg);
            }
