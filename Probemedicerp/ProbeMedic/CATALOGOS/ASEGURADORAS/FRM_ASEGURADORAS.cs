...
{
    public partial class FRM_ASEGURADORAS : FormaCatalogo
    {
        ...
        public override void BaseMetodoInicio()
        {
            ...
            BaseDtDatos = sql_Catalogos.Sk_Aseguradora();
        ...
        public override void BaseBotonGuardarClick()
        {
            ...
            {
                res = sql_Catalogos.In_Aseguradora(ref CampoIdentity, txtDescripcion.Text, txtCorto.Text, Convert.ToInt16(ucClientes1.K_Cliente), ref msg);

            }
            else //Existe. Update
            {
                CampoIdentity = Convert.ToInt16(CatalogoPropiedadId_Identity);
                res = sql_Catalogos.Up_Aseguradora(CampoIdentity, txtDescripcion.Text, txtCorto.Text, Convert.ToInt16(ucClientes1.K_Cliente), ref msg);
            }
        ...
        public override void BaseBotonBorrarClick()
        {
            ...
            {
                res = sql_Catalogos.Dl_Aseguradora(Convert.ToInt16(CatalogoPropiedadId_Identity), ref msg);
        ...
        public override bool BaseFuncionValidaciones()
        {
            ...
            if (ucClientes1.txt_Cliente.Text.Trim().Length == 0)
            {
        ...
        public override void CatalogoMetodoLlenaControles(DataRow ren)
        {
            ...
            txtClave.Text = ren["K_Aseguradora"].ToString();
            txtDescripcion.Text = ren["D_Aseguradora"].ToString();
            txtCorto.Text = ren["C_Aseguradora"].ToString();

            ucClientes1.K_Cliente = Convert.ToInt16(ren["K_Cliente"]);
            ucClientes1.txt_Cliente.Text = ren["D_Cliente"].ToString();
