...
{
    public partial class FRM_REPORTE_PRECIOS_ACTUALES : FormaBase
    {
        ...
        public FRM_REPORTE_PRECIOS_ACTUALES()
        {
            InitializeComponent();
        }

        private void FRM_REPORTE_PRECIOS_ACTUALES_Load(object sender, EventArgs e)
        {
        ...
        {
            datoss = sql_Catalogos.Sk_Proveedores_Articulos(PropiedadK_Proveedor);
