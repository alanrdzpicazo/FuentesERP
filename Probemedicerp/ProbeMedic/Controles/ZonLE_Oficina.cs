    ...
    public partial class ZonLE_Oficina : UserControl
    {
        ...
        private void BuscarOficina()
        {
            ...
            try
            {
                ...
                datos = catalogos_sql.SK_Zonificacion_Local_Enfermeria(K_Pais, K_Estado, K_Ciudad,K_Colonia);
