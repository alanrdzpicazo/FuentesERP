...
{
    public partial class txt_Moneda_UY : UserControl
    {       
        ...
        public void Formato(string numero)
        {
            if (numero != null)
            {
                ...
                {
                    decimal.TryParse(numero, out Valor);
                    Moneda.Text = Valor.ToString("#,##0.00", daDK); 
                }
                else
                {
                    Valor = nValor;
        ...
        public void Dinero()
        {
            ...
            if (decimal.TryParse(value, out ul))
            {
                ...
                Moneda.Text = string.Format(CultureInfo.CreateSpecificCulture("es-ES"), "{0:C2}", ul);
                Moneda.TextChanged += Moneda_TextChanged;
            }
        }        
