...
{
    public partial class Frm_PresupuestoIngresos : FormaBase
    {
        ...
        int intK_Cliente = 0;
        int intK_Cliente2 = 0;
        public Frm_PresupuestoIngresos()
        {
            InitializeComponent();
        ...
        {
            DataTable DtHistorial = SqlAdministracion.Sk_Historico_Presupuesto_Ingresos(sel_OficinaHistoria.K_Oficina, ucTipoVenta2.K_Tipo_Venta,
                ucFamiliaArticulo2.K_Familia_Articulo, intK_Cliente2, (int)numericUpDown1.Value, dtpInicio.Value, dtpFinal.Value);
        ...
        public override bool BaseFuncionValidaciones()
        {
            ...
            {
                MessageBox.Show("FALTA CAPTURAR TIPO DE VENTA...!", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                ucTipoVenta1.Focus();
                return false;
            }
            if (ucFamiliaArticulo1.K_Familia_Articulo == 0)
            {
                MessageBox.Show("FALTA CAPTURAR FAMILIA ARTICULO...!", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                ucFamiliaArticulo1.Focus();
                return false;
            }
            if (intK_Cliente == 0)
            {
                MessageBox.Show("FALTA CAPTURAR CLIENTE...!", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public override void BaseMetodoLimpiaControles()
        {
            ...
            ucTipoVenta1.K_Tipo_Venta = 0;
            ucTipoVenta1.txt_E_Tipo_Venta.Text = string.Empty;
            ...
            ucTipoVenta2.K_Tipo_Venta = 0;
            ucTipoVenta2.txt_E_Tipo_Venta.Text = string.Empty;
            ucFamiliaArticulo2.K_Familia_Articulo = 0;
            ucFamiliaArticulo2.txt_FA_D_Familia_Articulo.Text = string.Empty;
            txtClaveCliente2.Text = string.Empty;
            intK_Cliente2 = 0;
        ...
        public override void BaseBotonProceso2Click()
        {
            ...
            if (PropiedadEsRegistroNuevo) // Nuevo
            {
                ...
                {
                    res = SqlAdministracion.In_Presupuestos_Ingresos(sel_Oficina1.K_Oficina, ucTipoVenta1.K_Tipo_Venta,
                       ucFamiliaArticulo1.K_Familia_Articulo, intK_Cliente, (int)NumericUpDwn.Value, item.Mes, GlobalVar.K_Usuario, DateTime.Now,
                        item.Monto, ref msg);
            ...
            else //Existe. Update
            {
                foreach (var item in LstMeses)
                {
                    res = SqlAdministracion.Up_Presupuestos_Ingresos(sel_Oficina1.K_Oficina, ucTipoVenta1.K_Tipo_Venta,
                        ucFamiliaArticulo1.K_Familia_Articulo, intK_Cliente, (int)NumericUpDwn.Value, item.Mes, GlobalVar.K_Usuario, DateTime.Now,
                        item.Monto, ref msg);
        ...
        {
            DataTable DtPresupuestos = SqlAdministracion.Sk_Presupuestos_Ingresos(sel_Oficina1.K_Oficina, ucTipoVenta1.K_Tipo_Venta,
                ucFamiliaArticulo1.K_Familia_Articulo, intK_Cliente, (int)NumericUpDwn.Value, 0);
            ...
            ucTipoVenta1.K_Tipo_Venta = Convert.ToInt32(row["K_Tipo_Venta"].ToString());
            ucTipoVenta1.txt_E_Tipo_Venta.Text = row["D_Tipo_Venta"].ToString();
            ucFamiliaArticulo1.K_Familia_Articulo = Convert.ToInt32(row["K_Familia_Articulo"].ToString());
            ucFamiliaArticulo1.txt_FA_D_Familia_Articulo.Text = row["D_Familia_Articulo"].ToString();
            txtClaveCliente.Text = row["K_Cliente"].ToString();
            intK_Cliente = Convert.ToInt32(row["K_Cliente"].ToString());
        ...
        private void btnBuscaCliente2_Click(object sender, EventArgs e)
        {
            Busquedas.Frm_Busca_Cliente frm = new Busquedas.Frm_Busca_Cliente(GlobalVar.K_Empresa);
            frm.ShowDialog();
            ...
            {
                intK_Cliente2 = frm.LLave_Seleccionado;
                txtClaveCliente2.Text = Convert.ToString(frm.LLave_Seleccionado);
                txtCliente2.Text = frm.Descripcion_Seleccionado;
            }
        }
        ...
        private void Frm_PresupuestoIngresos_KeyDown(object sender, KeyEventArgs e)
        {
