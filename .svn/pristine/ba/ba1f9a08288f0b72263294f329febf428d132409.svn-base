...
{
    public partial class FRM_ZONIFICACION_LOCAL_AMB : FormaBase
    {
        ...
        int KOficina = 0, KPais = 0, KEdo = 0, KCd = 0, KCol = 0, res = -1, entra = 1;



        string DOficina = string.Empty, DPais = string.Empty, DEdo = string.Empty, DCd = string.Empty, DCol = string.Empty;
        ...
        public FRM_ZONIFICACION_LOCAL_AMB()
        {
            InitializeComponent();
        ...
        private void btn_Eliminar_Click(object sender, EventArgs e)
        {
            ...
            if (CbxTodas.Checked)
            {
                res = sql_Precios.Dl_Zonificacion_Local_Amb_All(ucOficinas1.K_Oficina, geo_Ciudades1.K_Pais, geo_Ciudades1.K_Estado, geo_Ciudades1.K_Ciudad, GlobalVar.K_Usuario, ref msg);
                if (res == -1)
                {
            ...
            else
            {
                ...
                if (K_Colonia_Asig != 0)
                {
                    res = sql_Catalogos.Dl_Zonificacion_Local_Ambulancia(ucOficinas1.K_Oficina, geo_Ciudades1.K_Pais, geo_Ciudades1.K_Estado, geo_Ciudades1.K_Ciudad, K_Colonia_Asig, GlobalVar.K_Usuario, ref msg);
        ...
        private void btn_Agregar_Click(object sender, EventArgs e)
        {
            ...
            if (CbxTodas.Checked)
            {
                res = sql_Precios.In_Zonificacion_Local_Amb_All(ucOficinas1.K_Oficina, geo_Ciudades1.K_Pais, geo_Ciudades1.K_Estado, geo_Ciudades1.K_Ciudad, GlobalVar.K_Usuario, ref msg);
                if (res == -1)
                {
                    BaseErrorResultado = true;
                    MessageBox.Show(msg, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            else
            {
                ...
                if (K_Colonia_Disp != 0)
                {
                    res = sql_Catalogos.In_Zonificacion_Local_Ambulancia(ucOficinas1.K_Oficina, geo_Ciudades1.K_Pais, geo_Ciudades1.K_Estado, geo_Ciudades1.K_Ciudad, K_Colonia_Disp, GlobalVar.K_Usuario, ref msg);
                    if (res == -1)
                    {
                        BaseErrorResultado = true;
                        MessageBox.Show(msg, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void FRM_ZONIFICACION_LOCAL_AMB_Load(object sender, EventArgs e)
        {
        ...
        private void Llena_Disponible()
        {
            ...
            CD_Disponibless = sql_Catalogos.Sk_Ciudades_Disp_Local(ucOficinas1.K_Oficina, geo_Ciudades1.K_Pais, geo_Ciudades1.K_Estado, geo_Ciudades1.K_Ciudad);
        ...
        private void Llena_Asignado()
        {
            ...
            CD_Asignadass = sql_Catalogos.SK_Zonificacion_Local_Ambulancia(ucOficinas1.K_Oficina, geo_Ciudades1.K_Pais, geo_Ciudades1.K_Estado, geo_Ciudades1.K_Ciudad);
        ...
        private void txt_E_Oficina_TextChanged(object sender, EventArgs e)
        {
            ...
            geo_Ciudades1.K_Ciudad = 0;
            geo_Ciudades1.txt_G_Ciudad.Clear();
            limpia();
        }
    }
