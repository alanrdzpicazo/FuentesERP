...
{
    public partial class FRM_ZONIFICACION_FPAMBULANCIA_ASEG : FormaBase
    {
        ...
        int K_Precio_Foraneo_Ambulancias = 0, K_Pais = 0, K_Estado = 0, K_Ciudad = 0, K_Oficina = 0, K_Precio_Ambulancia = 0, K_Aseguradora = 0;
        ...
        public FRM_ZONIFICACION_FPAMBULANCIA_ASEG()
        {
            InitializeComponent();
        }
        ...
        public void LLenarGrid(int K_Pais, Int32 K_Estado, Int32 K_Ciudad, Int32 K_Precio_Ambulancia, int K_Oficina, DateTime FechaInicial, DateTime FechaFinal, int K_Aseguradora)
        {
            datos = catalogosSQL.Sk_Zonificacion_FPAmbulancia_Aseg(Convert.ToInt16(K_Pais), K_Estado, K_Ciudad, K_Precio_Ambulancia, K_Oficina, FechaInicial, FechaFinal, K_Aseguradora);
            msg = string.Empty;
            ...
            if (datos != null)
            {
                ...
                grdDatos.Columns["K_Precio_Foraneo_AmbAseg"].HeaderText = "Clave";
        ...
        public override void BaseBotonGuardarClick()
        {
            ...
            try
            {
                res = catalogosSQL.In_Zonificacion_FPAmbulancia_Aseg(Convert.ToInt16(zonFA_Oficina1.K_Pais), Convert.ToInt32(zonFA_Oficina1.K_Estado), Convert.ToInt16(zonFA_Oficina1.K_Ciudad), Convert.ToInt32(K_Precio_Ambulancia), Convert.ToInt16(zonFA_Oficina1.K_Oficina), Convert.ToDecimal(txtPrecio.Text), FechaInicial, FechaFinal, Convert.ToInt16(ucAseguradora1.K_Aseguradora), ref msg);
            }
            catch (Exception ex)
            {
        ...
        public override void BaseBotonBuscarClick()
        {
            ...
            LLenarGrid(K_Pais, K_Estado, K_Ciudad, K_Precio_Ambulancia, K_Oficina, FechaInicial, FechaFinal, K_Aseguradora);
        ...
        public override void BaseBotonModificarClick()
        {
            ...
            BaseBotonGuardar.Enabled = false;
            K_Precio_Foraneo_Ambulancias = int.Parse(grdDatos.CurrentRow.Cells["K_Precio_Foraneo_AmbAseg"].Value.ToString());
            K_Pais = int.Parse(grdDatos.CurrentRow.Cells["K_Pais"].Value.ToString());
            K_Estado = int.Parse(grdDatos.CurrentRow.Cells["K_Estado"].Value.ToString());
            K_Ciudad = int.Parse(grdDatos.CurrentRow.Cells["K_Ciudad"].Value.ToString());
            K_Oficina = int.Parse(grdDatos.CurrentRow.Cells["K_Oficina"].Value.ToString());
            ...
            FRM_ACTUALIZA_ZONIFICACION_FPAMBULANCIA_ASEG actualiza = new FRM_ACTUALIZA_ZONIFICACION_FPAMBULANCIA_ASEG(K_Precio_Foraneo_Ambulancias, K_Pais, K_Ciudad, D_Ciudad, K_Estado, K_Oficina, K_Precio_Ambulancia, Convert.ToDecimal(grdDatos.CurrentRow.Cells["Precio"].Value.ToString()), FechaInicial, FechaFinal);
            actualiza.ShowDialog(this);
