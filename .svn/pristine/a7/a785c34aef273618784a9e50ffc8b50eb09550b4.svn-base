...
{
    public partial class Frm_RPT_RemisionesCanceladas: FormaBase
    {
        SQLAlmacen SQLALMACEN = new SQLAlmacen();
        SQLCatalogos SQLCATALOGOS = new SQLCatalogos();
        public Frm_RPT_RemisionesCanceladas()
        {
            InitializeComponent();
        }
        public override void BaseMetodoInicio()
        {
            ...
            this.txtFechaInicio.Value = dInicial;
            this.txtFechaFin.Value = dFinal;
        ...
        public override void BaseBotonBuscarClick()
        {
            ...
            dtDatos = SQLALMACEN.Sk_Remision(K_AlmacenInt,txtFechaInicio.Value,txtFechaFin.Value);
            if ((dtDatos!=null))
            {
