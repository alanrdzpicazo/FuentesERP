...
{
    public partial class Frm_NotaCargo : FormaBase
    {
        ...
        public override void BaseBotonProceso1Click()
        {
            ...
            Cbx_Motivo_Nota_Cargo.Focus();
            LblUsuarioAutorizo.Visible = false;
            Txt_Usuario_Autoriza.Visible = false;
            LblUsuarioGenero.Visible = false;
            Txt_Usuario_Genero.Visible = false;
        }
        //GUARDAR
...

        {
            ...
            if (PropiedadEsRegistroNuevo) // Nuevo
            {
                ...
                {
                    K_Cuenta = Convert.ToInt32(txtClaveCuentaOrigen.Text.Trim().ToString());
                }
                res = SQLADMINISTRACION.In_Nota_Cargo_Interna_Factura(ref CampoIdentity, K_Oficina,
                    Convert.ToInt32(cbxAlmacen.SelectedValue), K_Cliente, GlobalVar.K_Usuario, 0, DtpFechaGeneracion.Value,
                    ...
                    Convert.ToDecimal(Txt_Total_Retencion.Text), Convert.ToDecimal(TxtTotal.Text),Convert.ToInt32(Cbx_Motivo_Nota_Cargo.SelectedValue),
                    K_Cuenta,this.TxtObservaciones.Text, Convert.ToInt32(txtFactura.Text), ref msg);
                ...
                else
                {
                    ...
                    MessageBox.Show("Nota de Cargo Generada Correctamente con No. de Folio ["+CampoIdentity.ToString()+"]", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    BaseMetodoInicio();
        ...
        public override void BaseBotonProceso4Click()
        {
            ...
            {
                MessageBox.Show("DEBE BUSCAR UNA NOTA DE CARGO A ELIMINAR...!", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            DialogResult dlg = MessageBox.Show("SERA ELIMINADA LA NOTA DE CARGO CON FOLIO:\n" + txtClave.Text.Trim() + " \n¿DESEA CONTINUAR?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (dlg == DialogResult.Yes)
            {
                res = SQLADMINISTRACION.Dl_Nota_Cargo_Interna_Factura(Convert.ToInt16(txtClave.Text), GlobalVar.K_Usuario, ref msg);
        ...
        public override void BaseBotonBuscarClick()
        {
            ...
            DataTable Dt_NotasCargo = new DataTable();

            Dt_NotasCargo = SQLADMINISTRACION.Sk_Nota_Cargo_Interna_Factura();

            Busquedas.BuscaNotaCargoInternaFactura frm = new Busquedas.BuscaNotaCargoInternaFactura();
            frm.BusquedaPropiedadCamposBusqueda = DevuelveCamposBusqueda(Dt_NotasCargo);
            frm.BusquedaPropiedadTablaFiltra = Dt_NotasCargo;
            frm.BusquedaPropiedadTitulo = "Busca Nota Cargo Interna";
            frm.ShowDialog();
            ...
            if (frm.BusquedaPropiedadReglonRes != null)
            {
                ...
                MtdCargaTiposMotivos();
                MtdCargaAlmacen();
                this.txtClave.Text = frm.BusquedaPropiedadReglonRes["K_Nota_Cargo_Factura"].ToString();
                ...
                this.Cbx_Motivo_Nota_Cargo.SelectedValue = Convert.ToInt32(frm.BusquedaPropiedadReglonRes["K_Motivo_Nota_Cargo"]);
        ...
        public override bool BaseFuncionValidaciones()
        {
            ...
            if (Convert.ToInt32(Cbx_Motivo_Nota_Cargo.SelectedValue) == 0)
            {
        ...
        public override void BaseMetodoLimpiaControles()
        {
            ...
            Cbx_Motivo_Nota_Cargo.DataSource = null;
            Cbx_Motivo_Nota_Cargo.Items.Clear();
            Cbx_Motivo_Nota_Cargo.AutoCompleteSource = AutoCompleteSource.None;
            Cbx_Motivo_Nota_Cargo.AutoCompleteMode = AutoCompleteMode.None;
        ...
        private void btnBuscaCuentaOrigen_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("EL CLIENTE NO TIENE CUENTAS ASIGNADAS!...", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        ...
        private void MtdCargaTiposMotivos()
        {
            ...
            dtTiposMotivos = SQLCATALOGOS.Sk_Motivos_Nota_Cargo();

            if (dtTiposMotivos != null)
            {
                DataRow dr = dtTiposMotivos.NewRow();

                dr["K_Motivo_Nota_Cargo"] = 0;
                dr["D_Motivo_Nota_Cargo"] = "[Seleccionar]";
                ...
                int indice = -1;
                indice = 0;
                LlenaCombo(dtTiposMotivos, ref Cbx_Motivo_Nota_Cargo, "K_Motivo_Nota_Cargo", "D_Motivo_Nota_Cargo", indice);

                Cbx_Motivo_Nota_Cargo.SelectedIndex = 1;
            }
        }
        ...
        private void BtnFactura_Click(object sender, EventArgs e)
        {
            ...
            if (frm.row!=null)
            {
                txtFactura.Text =  frm.row.Cells["K_Factura"].Value.ToString();
                txtClaveOficina.Text = frm.row.Cells["K_Oficina1"].Value.ToString();
                txtOficina.Text = frm.row.Cells["D_Oficina1"].Value.ToString();
                K_Oficina = Convert.ToInt32(frm.row.Cells["K_Oficina1"].Value.ToString());
                MtdCargaAlmacen();
                cbxAlmacen.SelectedValue = Convert.ToInt32( frm.row.Cells["K_Almacen"].Value.ToString());
                k_Almacen = Convert.ToInt32(frm.row.Cells["K_Almacen"].Value.ToString());
            }
        }
        ...
        private void Cbx_Motivo_Nota_Cargo_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = true;
        }
