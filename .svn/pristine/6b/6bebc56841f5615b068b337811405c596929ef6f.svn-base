...
{
    public partial class FRM_ESTADOS : FormaCatalogo
    {
        int res = 0;
        ...
        public override void CatalogoMetodoLlenaControles(DataRow ren)
        {
            ...
            txtClave.Text = ren["K_Estado"].ToString();
            txtDescripcion.Text = ren["D_Estado"].ToString();
            txtCorto.Text = ren["C_Estado"].ToString();
        ...
        public override void BaseBotonBorrarClick()
        {
            ...
            {
                res = CatalogosSQL.Dl_Estado(Convert.ToInt16(CatalogoPropiedadId_Identity), ref msg);
        ...
        public override void BaseBotonGuardarClick()
        {
            ...
            {
                res = CatalogosSQL.In_Estado(Convert.ToInt16(cmbPais.SelectedValue), ref CampoIdentity, txtDescripcion.Text, txtCorto.Text, ref msg);
            }
            else //Existe. Update
            {
                CampoIdentity = Convert.ToInt16(CatalogoPropiedadId_Identity);
                res = CatalogosSQL.Up_Estado(Convert.ToInt16(cmbPais.SelectedValue), CampoIdentity, txtDescripcion.Text, txtCorto.Text, ref msg);
            }
