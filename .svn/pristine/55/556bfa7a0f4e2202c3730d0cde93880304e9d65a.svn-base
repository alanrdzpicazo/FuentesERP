...
{
    partial class Frm_Busca_Tipo_Dato
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "Frm_Busca_Tipo_Dato";
            this.Text = "Busca Tipo De Dato";
            this.Load += new System.EventHandler(this.Frm_Busca_Tipo_Dato_Load);
