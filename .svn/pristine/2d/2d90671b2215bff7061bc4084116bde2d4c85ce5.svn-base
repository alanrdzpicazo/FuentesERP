...
{
    public partial class FRM_PAGO_SERV_ENF : FormaBase
    {
        ...
        public FRM_PAGO_SERV_ENF()
        {
            InitializeComponent();
        }

        private void FRM_PAGO_SERV_ENF_Load(object sender, EventArgs e)
        {      
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            res = sql_ventas.In_Pagos_Enfermeria(
                NumServicio,
                K_Banco,
                txtNumTarjeta.Text,
        ...
        {
            dt = sql_ventas.Sk_Pagos_Enfermeria(NumServicio);
