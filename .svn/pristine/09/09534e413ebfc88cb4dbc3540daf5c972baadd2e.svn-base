...
{
    public partial class FRM_ZONIFICACION_LPAMBULANCIA_ASEG : FormaBase
    {
        ...
        int K_Precio_Local_Ambulancias = 0, K_Pais = 0, K_Estado = 0, K_Ciudad = 0, K_Oficina = 0,K_Colonia=0, K_Precio_Ambulancia = 0, K_Aseguradora = 0;
        ...
        private void FRM_ZONIFICACION_LPAMBULANCIA_ASEG_Load(object sender, EventArgs e)
        {
           
        
        }

        public FRM_ZONIFICACION_LPAMBULANCIA_ASEG()
        {
            InitializeComponent();
        }
        ...
        public void LLenarGrid(int K_Pais, Int32 K_Estado, Int32 K_Ciudad, Int32 K_Precio_Ambulancia, int K_Oficina,int K_Colonia, DateTime FechaInicial, DateTime FechaFinal,int K_Aseguradora)
        {
            //res = 0;
            msg = string.Empty;

            datos = catalogosSQL.Sk_Zonificacion_LPAmbulancia_Aseg(Convert.ToInt16(K_Pais), K_Estado, K_Ciudad, K_Precio_Ambulancia, K_Oficina, FechaInicial, FechaFinal, K_Aseguradora);
            if (datos != null)
            {          
                ...
                grdDatos.Columns["K_Precio_Local_AmbAseg"].HeaderText = "Clave";
        ...
        public override void BaseBotonGuardarClick()
        {
            ...
            try
            {
                res = catalogosSQL.In_Zonificacion_LPAmbulancia_Aseg(Convert.ToInt16(zonLA_Oficina1.K_Pais), Convert.ToInt32(zonLA_Oficina1.K_Estado), Convert.ToInt16(zonLA_Oficina1.K_Ciudad), Convert.ToInt32(K_Precio_Ambulancia), Convert.ToInt16(zonLA_Oficina1.K_Oficina),zonLA_Oficina1.K_Colonia, Convert.ToDecimal(txtPrecio.Text), FechaInicial, FechaFinal,Convert.ToInt16(ucAseguradora1.K_Aseguradora), ref msg);
            }
            catch (Exception ex)
            {
        ...
        public override void BaseBotonBuscarClick()
        {
            ...
            K_Aseguradora = ucAseguradora1.K_Aseguradora;

            LLenarGrid(K_Pais, K_Estado, K_Ciudad, K_Precio_Ambulancia, K_Oficina,K_Colonia, FechaInicial, FechaFinal,K_Aseguradora);
        ...
        private void zonLA_Oficina1_Load(object sender, EventArgs e)
        {
        ...
        private void BtnAgergar_Click(object sender, EventArgs e)
        {
            ...
            if (CbxTodas.Checked)
            {
                try
                {
                    res = PreciosSQL.In_Zonificacion_LPAmbulancia_Aseg_All(Convert.ToInt16(zonLA_Oficina1.K_Pais), Convert.ToInt32(zonLA_Oficina1.K_Estado),
            ...
            else
            {
                ...
                try
                {
                    res = catalogosSQL.In_Zonificacion_LPAmbulancia_Aseg(Convert.ToInt16(zonLA_Oficina1.K_Pais), Convert.ToInt32(zonLA_Oficina1.K_Estado), 
                        Convert.ToInt16(zonLA_Oficina1.K_Ciudad), Convert.ToInt32(K_Precio_Ambulancia), Convert.ToInt16(zonLA_Oficina1.K_Oficina), zonLA_Oficina1.K_Colonia,
                        Convert.ToDecimal(txtPrecio.Text), FechaInicial, FechaFinal, Convert.ToInt16(ucAseguradora1.K_Aseguradora), ref msg);
                }
                catch (Exception ex)
                {
        ...
        private void FRM_ZONIFICACION_LPAMBULANCIA_ASEG_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        public override void BaseBotonModificarClick()
        {
            ...
            BaseBotonGuardar.Enabled = false;
            K_Precio_Local_Ambulancias = int.Parse(grdDatos.CurrentRow.Cells["K_Precio_Local_AmbAseg"].Value.ToString());
            K_Pais = int.Parse(grdDatos.CurrentRow.Cells["K_Pais"].Value.ToString());
            K_Estado = int.Parse(grdDatos.CurrentRow.Cells["K_Estado"].Value.ToString());
            K_Ciudad = int.Parse(grdDatos.CurrentRow.Cells["K_Ciudad"].Value.ToString());
            K_Oficina = int.Parse(grdDatos.CurrentRow.Cells["K_Oficina"].Value.ToString());
            ...
            FRM_ACTUALIZA_ZONIFICACION_LPAMBULANCIA_ASEG actualiza = new FRM_ACTUALIZA_ZONIFICACION_LPAMBULANCIA_ASEG(K_Precio_Local_Ambulancias, K_Pais, K_Ciudad, D_Ciudad, K_Estado, K_Oficina, K_Precio_Ambulancia, Convert.ToDecimal(grdDatos.CurrentRow.Cells["Precio"].Value.ToString()), FechaInicial, FechaFinal);
            actualiza.ShowDialog(this);
