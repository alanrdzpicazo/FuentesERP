...
{
    public partial class FRM_SERV_CONT_AMB_DETALLE : FormaBase
    {
        ...
        public FRM_SERV_CONT_AMB_DETALLE()
        {
            InitializeComponent();
        }

        private void FRM_SERV_CONT_AMB_DETALLE_Load(object sender, EventArgs e)
        {
        ...
        {
            dtDetalle = sqlprecios.SK_Detalle_ArticulosAmbulancia(Convert.ToInt32(NoServicio));
