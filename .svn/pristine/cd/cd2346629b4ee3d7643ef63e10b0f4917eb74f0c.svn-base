...
namespace ProbeMedic.CATALOGOS
{
    public partial class FRM_FAMILIA_ARTICULO : FormaCatalogo
    {
        ...
        public override void BaseBotonGuardarClick()
        {
            ...
            {
                res = sql_Catalogos.In_Famila_Articulo(ref CampoIdentity, txtDescripcion.Text, ref msg);

            }
            else //Existe. Update
            {
                CampoIdentity = Convert.ToInt16(CatalogoPropiedadId_Identity);
                res = sql_Catalogos.Up_Familia_Articulos(CampoIdentity, txtDescripcion.Text, ref msg);
            }
        ...
        public override void CatalogoMetodoLlenaControles(DataRow ren)
        {
            ...
            cbxActivo.Checked = Convert.ToBoolean(ren["B_Activo"]);
